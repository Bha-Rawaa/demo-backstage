...
//import  BranchByEnvPage  from '@internal/backstage-plugin-branch-by-env';
import DatabaseTable from '@internal/backstage-plugin-branch-by-env/src/components/DataComponent/data';
...
const routes = (
  <FlatRoutes>
    ...
    <Route path="/branch-by-env" element={<DatabaseTable  />} />
  </FlatRoutes>
);
